...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.QUARTERSTAFF, Models.GENERATED);
        ...
        itemModelGenerator.register(ModItems.ARTORIAS_DESPAIR, Models.GENERATED);
        itemModelGenerator.register(ModItems.HELENA_BASEBALL_BAT, Models.GENERATED);
        itemModelGenerator.register(ModItems.HILDA_SCYTHE, Models.GENERATED);
        itemModelGenerator.register(ModItems.DIEGO_RAPIER, Models.GENERATED);
        itemModelGenerator.register(ModItems.AKIRA_KATANA, Models.GENERATED);
        itemModelGenerator.register(ModItems.ODIN_DAGGER, Models.GENERATED);
        itemModelGenerator.register(ModItems.SAI, Models.GENERATED);
        itemModelGenerator.register(ModItems.VEIGAR_STAFF, Models.GENERATED);
        itemModelGenerator.register(ModItems.QRAZ_STAFF, Models.GENERATED);
        itemModelGenerator.register(ModItems.SYLVERIA_STAFF, Models.GENERATED);
        itemModelGenerator.register(ModItems.NOVUS_GRIMOIRE, Models.GENERATED);
        itemModelGenerator.register(ModItems.CARSON_CANNON, Models.GENERATED);
        ...
        itemModelGenerator.register(ModItems.SAW_EATER, Models.GENERATED);
        itemModelGenerator.register(ModItems.LADON_DRAGON_GLAIVE, Models.GENERATED);
        itemModelGenerator.register(ModItems.ERAK_BATTLEAXE, Models.GENERATED);
        itemModelGenerator.register(ModItems.BELAIOS_WAND, Models.GENERATED);
